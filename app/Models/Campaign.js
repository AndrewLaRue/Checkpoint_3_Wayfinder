            ...
            <form onsubmit="app.unitsController.createUnit('${this.id}')">
              <div class="row pt-1 align-items-center">
                ...
                <div class="col-4 col-md-2">
                  <input required class="border-bottom border-2 border-dark text-center clear heavy" type="text" placeholder="Unit" name="name" id="name" title="Unit">
                </div>
                <div class="col-4 col-md-2">
                ...
                <div class="col-4 col-md-3">
                  <input required class="border-bottom border-2 border-dark text-center clear heavy" type="text" placeholder="Location" name="address" id="address" title="Location">
                </div>
                <div class="col-4 col-md-2">
                ...
                <div class="col-2 col-md-1 px-0">
                  <input required step="100" value="" class="border-bottom border-2 border-dark text-center clear heavy" type="Number" placeholder="Cost" name="cost" id="cost" title="Cost">
                </div>
